...
<div class="col-md-3 col-6 mb-4">
    <div class="card">
        <img src="{{asset('images')}}/{{$femme->image}}" classe="card-img-top">
        <div class="card-body">
            <h4 class="card-title">{{$femme->name}}</h4>
            <p>{{$femme->author}}</p>
            <p class="card-text"><strong>price:</strong>{{$femme->price}}DH</p>
            <p class="btn-holder"><a href="{{route('addfemme.to.cart',$femme->id)}}" class="btn btn-outline-dark">add to cart</a></p>
        </div>
    </div>
</div>
