<style>/* CSS for Card Elements */
 ...
 <div class="col-md-3 col-6 mb-4">
     <div class="card">
         <img src="{{asset('images')}}/{{$homme->image}}" classe="card-img-top">
         <div class="card-body">
             <h4 class="card-title">{{$homme->name}}</h4>
             <p>{{$homme->author}}</p>
             <p class="card-text"><strong>price:</strong>{{$homme->price}}DH</p>
             <p class="btn-holder"><a href="{{route('addhomme.to.cart',$homme->id)}}" class="btn btn-outline-dark">add to cart</a></p>
         </div>
     </div>
 </div>
